                            ...
                            <div class="card-tools">
                                <div class="input-group input-group-sm" style="width: 250px;">
                                    ...
                                    <div class="input-group-append">
                                        ...
                                        <a href="{{ route('categoria_convocatoria.create') }}"
                                ...
                                <table id="table" class="table table-hover table-bordered">
                                    ...
                                    @foreach( $categorys as $category )
                                        <tr class="cat{{$category->id}}">
                                            ...
                                            <td width="10px">
                                                <a href="{{ route('categoria_convocatoria.edit', $category->id) }}" class=" btn btn-info btn-sm">
                                                    <i class="fa fa-eye"></i>
                                                </a>
                                            </td>
                                            <td width="10px">
                                                <a href="{{ route('categoria_convocatoria.edit', $category->id) }}" class="edit-modal-cat btn btn-warning btn-sm">
                                                    <i class="fa fa-pencil"></i>
                                                </a>
                                            </td>
                                            <td width="10px">
                                                {!! Form::open(['route' => ['categoria_convocatoria.destroy', $category->id], 'method' => 'DELETE']) !!}
